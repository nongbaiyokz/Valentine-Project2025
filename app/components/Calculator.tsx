        ...
        <div className="flex justify-center items-center h-screen bg-base-200">
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className="card-title animate-bounce justify-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
Card Title</h2>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        ...
                        <button className="btn btn-active btn-info motion-safe:hover:scale-110" onClick={handleClearClick}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
...
Clear</button>
                        <button className="btn btn-active btn-success motion-safe:hover:scale-110" onClick={handleEqualClick}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
